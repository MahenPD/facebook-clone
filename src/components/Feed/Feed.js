...
function Feed() {
  ...
  return (
    <div className="feed">
      ...
      {posts.map(post => (
        <Post key={post.id} profilePic={post.data.profilePic} message={post.data.message} timestamp={post.data.timestamp} username={post.data.username} image={post.data.username}/>
      ))}
